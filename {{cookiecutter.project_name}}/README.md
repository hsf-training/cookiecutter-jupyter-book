...
[![deploy-book](https://github.com/hsf-training/{{cookiecutter.project_name}}/actions/workflows/deploy.yml/badge.svg)](https://github.com/hsf-training/{{cookiecutter.project_name}}/actions/workflows/deploy.yml)
